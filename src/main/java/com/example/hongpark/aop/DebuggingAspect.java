...
@Component // IoC가 컨테이너가 해당 객체를 생성 및 관리
@Slf4j
...
//    @Pointcut("execution(* com.example.hongpark.service.CommentsService.create(..))")
    ...
    @Before("cut()")
    public void loggingArgs(JoinPoint joinPoint) { // cut()의 대상 메소드(정확히는 메소드는 아니고 메소드를 둘러싼 결합지점)
        // 입력값 가져오기
    ...
    public void loggingReturnValue(JoinPoint joinPoint, Object returnObj) { //Object : 리턴값
